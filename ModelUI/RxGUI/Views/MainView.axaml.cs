    ...
    public partial class MainView : UserControl
    {
        ...
        public void PopulateDatabaseFields()
        {
            ...
            headerGrid.Children.Add(new TextBlock
                { Text = "JSON", FontWeight = FontWeight.Bold, Margin = new Thickness(4, 0, 0, 0) });
            headerGrid.Children.Add(new TextBlock
                { Text = "AnyData", FontWeight = FontWeight.Bold, Margin = new Thickness(4, 0, 0, 0) });
        ...
        private void AddInstance_Click(object? sender, RoutedEventArgs e) => viewModel.AddInstance();
        private void RemoveInstance_Click(object? sender, RoutedEventArgs e) => viewModel.RemoveSelectedInstance();
        ...
        private void ConnectClient_Click(object? sender, RoutedEventArgs e) => viewModel.ConnectClient();

        private void DisconnectClient_Click(object? sender, RoutedEventArgs e) => viewModel.DisconnectClient();

        private void SendJson_Click(object? sender, RoutedEventArgs e) => viewModel.SendJson();
    }
}
